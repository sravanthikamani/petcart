...
import bottom_banner_image_sm from "./bottom_banner_image_sm.avif";
...
import dog_food_img from "./dog_food_img.webp";
import cat_food_img from "./cat_food_img.jpg";
import toys from "./toys.jpg";
import beds_mats_img from "./beds_mats_img.jpg";
import bowls_feeders from "./bowls_feeders.jpg";
import walk_essentials_img from "./walk_essentials_img.jpg";
import fashion_img from "./fashion_img.jpg";
export const assets = {
  logo,
  search_icon,
  remove_icon,
...
export const categories = [
  ...
  },
  {
    ...
    path: "Walk Essenstials",
    image: walk_essentials_img,
    bgColor: "#E0F6FE",
  },
  {
    text: "Fashion",
